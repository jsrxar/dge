    ...
    class public_sga_espacioPage extends Page
    {
        ...
        protected function CreateGridSearchControl(Grid $grid)
        {
            ...
            $grid->SearchControl = new SimpleSearch('public_sga_espaciossearch', $this->dataset,
                ...
                array($this->RenderText('Id Espacio'), $this->RenderText('Tipo Espacio'), $this->RenderText('Sector'), $this->RenderText('Código Espacio'), $this->RenderText('Nombre Espacio'), $this->RenderText('Código Plano'), $this->RenderText('Planta'), $this->RenderText('Descripción')),
                array(
