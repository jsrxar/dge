    ...
    class public_sga_tarea_planPage extends Page
    {
        ...
        protected function CreateGridSearchControl(Grid $grid)
        {
            ...
            $grid->SearchControl = new SimpleSearch('public_sga_tarea_planssearch', $this->dataset,
                ...
                array($this->RenderText('Id Tarea Plan'), $this->RenderText('Acción'), $this->RenderText('Espacio'), $this->RenderText('Bien'), $this->RenderText('Periodicidad'), $this->RenderText('Detalle'), $this->RenderText('Referencia'), $this->RenderText('Fe Inicio')),
                array(
        ...
        protected function CreateGridAdvancedSearchControl(Grid $grid)
        {
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateDateTimeSearchInput('fe_inicio', $this->RenderText('Fe Inicio'), 'Y-m-d H:i:s'));
        }
        ...
        protected function AddSingleRecordViewColumns(Grid $grid)
        {
            ...
            //
            $column = new DateTimeViewColumn('fe_inicio', 'Fe Inicio', $this->dataset);
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            $editor = new DateTimeEdit('fe_inicio_edit', true, 'Y-m-d H:i:s', GetFirstDayOfWeek());
            $editColumn = new CustomEditColumn('Fe Inicio', 'fe_inicio', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        }
