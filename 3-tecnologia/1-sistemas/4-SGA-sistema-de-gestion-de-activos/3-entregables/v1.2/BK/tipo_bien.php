    ...
    class public_sga_tipo_bienPage extends Page
    {
        ...
        protected function CreateGridSearchControl(Grid $grid)
        {
            ...
            $grid->SearchControl = new SimpleSearch('public_sga_tipo_bienssearch', $this->dataset,
                ...
                array($this->RenderText('Id Tipo Bien'), $this->RenderText('Nombre Tipo Bien'), $this->RenderText('Tipo Bien Padre'), $this->RenderText('Descripción')),
                array(
        ...
        public function GetModalGridViewHandler() { return 'public_sga_tipo_bien_inline_record_view'; }
