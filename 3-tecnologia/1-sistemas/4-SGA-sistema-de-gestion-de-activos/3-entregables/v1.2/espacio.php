    ...
    class public_sga_espacioPage extends Page
    {
        ...
        protected function CreateGridSearchControl(Grid $grid)
        {
            ...
            $grid->SearchControl = new SimpleSearch('public_sga_espaciossearch', $this->dataset,
                array('id_espacio', 'id_tipo_espacio_ds_referencia', 'id_espacio_contenedor_ds_referencia', 'id_sector_no_sector', 'co_espacio', 'no_espacio', 'co_plano', 'id_planta_no_planta', 'ds_referencia'),
                array($this->RenderText('Id Espacio'), $this->RenderText('Tipo Espacio'), $this->RenderText('Espacio Contenedor'), $this->RenderText('Sector'), $this->RenderText('Código Espacio'), $this->RenderText('Nombre Espacio'), $this->RenderText('Código Plano'), $this->RenderText('Planta'), $this->RenderText('Descripción')),
                array(
