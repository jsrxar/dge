    ...
    class public_sga_tipo_accionPage extends Page
    {
        ...
        protected function CreateGridSearchControl(Grid $grid)
        {
            ...
            $grid->SearchControl = new SimpleSearch('public_sga_tipo_accionssearch', $this->dataset,
                ...
                array($this->RenderText('Id Tipo Acción'), $this->RenderText('Nombre Tipo Acción'), $this->RenderText('Tipo Acción Padre'), $this->RenderText('Descripción')),
                array(
        ...
        public function GetModalGridViewHandler() { return 'public_sga_tipo_accion_inline_record_view'; }
