 ...
 */
    ...
    class public_ods_tipo_accionPage extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            $this->dataset->AddField($field, false);
            $this->dataset->AddLookupField('id_tipo_accion_padre', 'public.ods_tipo_accion', new IntegerField('id_tipo_accion', null, null, true), new StringField('no_tipo_accion', 'id_tipo_accion_padre_no_tipo_accion', 'id_tipo_accion_padre_no_tipo_accion_public_ods_tipo_accion'), 'id_tipo_accion_padre_no_tipo_accion_public_ods_tipo_accion');
        }
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('public_ods_tipo_accionssearch', $this->dataset,
                array('id_tipo_accion', 'no_tipo_accion', 'id_tipo_accion_padre_no_tipo_accion', 'ds_referencia'),
                array($this->RenderText('Id Tipo Accion'), $this->RenderText('No Tipo Accion'), $this->RenderText('Id Tipo Accion Padre'), $this->RenderText('Ds Referencia')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('public_ods_tipo_accionasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            $this->AdvancedSearchControl->setTimerInterval(1000);
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('id_tipo_accion', $this->RenderText('Id Tipo Accion')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('no_tipo_accion', $this->RenderText('No Tipo Accion')));
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateLookupSearchInput('id_tipo_accion_padre', $this->RenderText('Id Tipo Accion Padre'), $lookupDataset, 'id_tipo_accion', 'no_tipo_accion', false, 8));
        ...
        protected function AddFieldColumns(Grid $grid)
        {
            ...
            //
            $column = new TextViewColumn('id_tipo_accion', 'Id Tipo Accion', $this->dataset);
            ...
            $column->SetFullTextWindowHandlerName('public_ods_tipo_accionGrid_no_tipo_accion_handler_list');
            ...
            // View column for no_tipo_accion field
            //
            $column = new TextViewColumn('id_tipo_accion_padre_no_tipo_accion', 'Id Tipo Accion Padre', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText('Identificador único del tipo de acción contenedora.'));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('public_ods_tipo_accionGrid_ds_referencia_handler_list');
        ...
        protected function AddSingleRecordViewColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('public_ods_tipo_accionGrid_no_tipo_accion_handler_view');
            $grid->AddSingleRecordViewColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('public_ods_tipo_accionGrid_ds_referencia_handler_view');
            $grid->AddSingleRecordViewColumn($column);
        }
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $editColumn = new CustomEditColumn('No Tipo Accion', 'no_tipo_accion', $editor, $this->dataset);
        ...
        public function GetModalGridDeleteHandler() { return 'public_ods_tipo_accion_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'public_ods_tipo_accionGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
            ...
            $column = new TextViewColumn('no_tipo_accion', 'No Tipo Accion', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'public_ods_tipo_accionGrid_no_tipo_accion_handler_list', $column);
            ...
            $column = new TextViewColumn('ds_referencia', 'Ds Referencia', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'public_ods_tipo_accionGrid_ds_referencia_handler_list', $column);
            GetApplication()->RegisterHTTPHandler($handler);//
            // View column for no_tipo_accion field
            //
            $column = new TextViewColumn('no_tipo_accion', 'No Tipo Accion', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'public_ods_tipo_accionGrid_no_tipo_accion_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            //
            // View column for ds_referencia field
            //
            $column = new TextViewColumn('ds_referencia', 'Ds Referencia', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'public_ods_tipo_accionGrid_ds_referencia_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            return $result;
        }
    ...
    try
    {
        $Page = new public_ods_tipo_accionPage("tipo_accion.php", "public_ods_tipo_accion", GetCurrentUserGrantForDataSource("public.ods_tipo_accion"), 'UTF-8');
        $Page->SetShortCaption('Tipo Accion');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Tipo Accion');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("public.ods_tipo_accion"));
