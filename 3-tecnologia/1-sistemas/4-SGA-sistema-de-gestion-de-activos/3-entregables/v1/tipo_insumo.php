 ...
 */
    ...
    class public_ods_tipo_insumoPage extends Page
    {
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('public_ods_tipo_insumossearch', $this->dataset,
                array('id_tipo_insumo', 'no_tipo_insumo'),
                array($this->RenderText('Id Tipo Insumo'), $this->RenderText('Nombre Tipo Insumo')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('public_ods_tipo_insumoasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            $this->AdvancedSearchControl->setTimerInterval(1000);
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('id_tipo_insumo', $this->RenderText('Id Tipo Insumo')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('no_tipo_insumo', $this->RenderText('Nombre Tipo Insumo')));
        }
        ...
        {
            //
            // View column for id_tipo_insumo field
            //
            $column = new TextViewColumn('id_tipo_insumo', 'Id Tipo Insumo', $this->dataset);
            ...
            //
            $column = new TextViewColumn('no_tipo_insumo', 'Nombre Tipo Insumo', $this->dataset);
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('public_ods_tipo_insumoGrid_no_tipo_insumo_handler_list');
            $column->SetDescription($this->RenderText('Nombre del tipo de insumo.'));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
        }
        ...
        protected function AddSingleRecordViewColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('public_ods_tipo_insumoGrid_no_tipo_insumo_handler_view');
            $grid->AddSingleRecordViewColumn($column);
        }
        ...
        {
            //
            // Edit column for no_tipo_insumo field
            //
            $editor = new TextEdit('no_tipo_insumo_edit');
            $editor->SetSize(100);
            $editor->SetMaxLength(100);
            $editColumn = new CustomEditColumn('Nombre Tipo Insumo', 'no_tipo_insumo', $editor, $this->dataset);
        ...
        protected function AddPrintColumns(Grid $grid)
        {
            ...
            // View column for no_tipo_insumo field
            //
            $column = new TextViewColumn('no_tipo_insumo', 'No Tipo Insumo', $this->dataset);
            $column->SetOrderable(true);
            $grid->AddPrintColumn($column);
        }
        ...
        public function GetModalGridDeleteHandler() { return 'public_ods_tipo_insumo_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'public_ods_tipo_insumoGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
            ...
            $column = new TextViewColumn('no_tipo_insumo', 'Nombre Tipo Insumo', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'public_ods_tipo_insumoGrid_no_tipo_insumo_handler_list', $column);
            GetApplication()->RegisterHTTPHandler($handler);//
            // View column for no_tipo_insumo field
            //
            $column = new TextViewColumn('no_tipo_insumo', 'Nombre Tipo Insumo', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'public_ods_tipo_insumoGrid_no_tipo_insumo_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            return $result;
        }
    ...
    try
    {
        $Page = new public_ods_tipo_insumoPage("tipo_insumo.php", "public_ods_tipo_insumo", GetCurrentUserGrantForDataSource("public.ods_tipo_insumo"), 'UTF-8');
        $Page->SetShortCaption('Tipo Insumo');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Tipo Insumo');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("public.ods_tipo_insumo"));
