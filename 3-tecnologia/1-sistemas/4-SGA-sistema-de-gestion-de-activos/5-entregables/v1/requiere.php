 ...
 */
    ...
    class public_ods_requierePage extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            $field = new IntegerField('id_insumo');
            $field->SetIsNotNull(true);
            $this->dataset->AddField($field, true);
            $this->dataset->AddLookupField('id_insumo', 'public.ods_insumo', new IntegerField('id_insumo', null, null, true), new StringField('no_insumo', 'id_insumo_no_insumo', 'id_insumo_no_insumo_public_ods_insumo'), 'id_insumo_no_insumo_public_ods_insumo');
        }
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('public_ods_requieressearch', $this->dataset,
                array('id_insumo_no_insumo'),
                array($this->RenderText('Id Insumo')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('public_ods_requiereasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateLookupSearchInput('id_insumo', $this->RenderText('Id Insumo'), $lookupDataset, 'id_insumo', 'no_insumo', false, 8));
        }
        ...
        protected function AddFieldColumns(Grid $grid)
        {
            ...
            //
            $column = new TextViewColumn('id_insumo_no_insumo', 'Id Insumo', $this->dataset);
        ...
        public function GetModalGridDeleteHandler() { return 'public_ods_requiere_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'public_ods_requiereGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
    ...
    try
    {
        $Page = new public_ods_requierePage("requiere.php", "public_ods_requiere", GetCurrentUserGrantForDataSource("public.ods_requiere"), 'UTF-8');
        $Page->SetShortCaption('Requiere (Actividad / Insumo)');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Requiere');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("public.ods_requiere"));
