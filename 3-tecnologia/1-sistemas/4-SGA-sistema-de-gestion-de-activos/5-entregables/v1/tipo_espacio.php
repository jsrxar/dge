 ...
 */
    ...
    class public_ods_tipo_espacioPage extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            $this->dataset->AddField($field, false);
            $this->dataset->AddLookupField('id_tipo_espacio_padre', 'public.ods_tipo_espacio', new IntegerField('id_tipo_espacio', null, null, true), new StringField('ds_referencia', 'id_tipo_espacio_padre_ds_referencia', 'id_tipo_espacio_padre_ds_referencia_public_ods_tipo_espacio'), 'id_tipo_espacio_padre_ds_referencia_public_ods_tipo_espacio');
        }
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('public_ods_tipo_espaciossearch', $this->dataset,
                array('id_tipo_espacio', 'no_tipo_espacio', 'id_tipo_espacio_padre_ds_referencia', 'ds_referencia'),
                array($this->RenderText('Id Tipo Espacio'), $this->RenderText('Nombre Tipo Espacio'), $this->RenderText('Id Tipo Espacio Padre'), $this->RenderText('Ds Referencia')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('public_ods_tipo_espacioasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('no_tipo_espacio', $this->RenderText('Nombre Tipo Espacio')));
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateLookupSearchInput('id_tipo_espacio_padre', $this->RenderText('Id Tipo Espacio Padre'), $lookupDataset, 'id_tipo_espacio', 'ds_referencia', false, 8));
        ...
        protected function AddFieldColumns(Grid $grid)
        {
            ...
            //
            $column = new TextViewColumn('no_tipo_espacio', 'Nombre Tipo Espacio', $this->dataset);
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('public_ods_tipo_espacioGrid_no_tipo_espacio_handler_list');
            ...
            //
            $column = new TextViewColumn('id_tipo_espacio_padre_ds_referencia', 'Id Tipo Espacio Padre', $this->dataset);
            $column->SetOrderable(true);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('public_ods_tipo_espacioGrid_ds_referencia_handler_list');
        ...
        protected function AddSingleRecordViewColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('public_ods_tipo_espacioGrid_no_tipo_espacio_handler_view');
            $grid->AddSingleRecordViewColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('public_ods_tipo_espacioGrid_ds_referencia_handler_view');
            $grid->AddSingleRecordViewColumn($column);
        }
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $editColumn = new CustomEditColumn('Nombre Tipo Espacio', 'no_tipo_espacio', $editor, $this->dataset);
        ...
        public function GetModalGridDeleteHandler() { return 'public_ods_tipo_espacio_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'public_ods_tipo_espacioGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
            ...
            $column = new TextViewColumn('no_tipo_espacio', 'Nombre Tipo Espacio', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'public_ods_tipo_espacioGrid_no_tipo_espacio_handler_list', $column);
            ...
            $column = new TextViewColumn('ds_referencia', 'Ds Referencia', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'public_ods_tipo_espacioGrid_ds_referencia_handler_list', $column);
            GetApplication()->RegisterHTTPHandler($handler);//
            // View column for no_tipo_espacio field
            //
            $column = new TextViewColumn('no_tipo_espacio', 'Nombre Tipo Espacio', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'public_ods_tipo_espacioGrid_no_tipo_espacio_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            //
            // View column for ds_referencia field
            //
            $column = new TextViewColumn('ds_referencia', 'Ds Referencia', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'public_ods_tipo_espacioGrid_ds_referencia_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            return $result;
        }
    ...
    try
    {
        $Page = new public_ods_tipo_espacioPage("tipo_espacio.php", "public_ods_tipo_espacio", GetCurrentUserGrantForDataSource("public.ods_tipo_espacio"), 'UTF-8');
        $Page->SetShortCaption('Tipo Espacio');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Tipo Espacio');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("public.ods_tipo_espacio"));
