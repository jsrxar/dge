    ...
    class public_ods_accionPage extends Page
    {
        ...
        protected function CreateGridSearchControl(Grid $grid)
        {
            ...
            $grid->SearchControl = new SimpleSearch('public_ods_accionssearch', $this->dataset,
                ...
                array($this->RenderText('Id Accion'), $this->RenderText('Id Tipo Espacio'), $this->RenderText('Id Tipo Bien'), $this->RenderText('Id Origen'), $this->RenderText('Id Metodologia'), $this->RenderText('Id Periodicidad'), $this->RenderText('A Demanda'), $this->RenderText('Descripción Referencia'), $this->RenderText('Id Tipo Accion')),
                array(
