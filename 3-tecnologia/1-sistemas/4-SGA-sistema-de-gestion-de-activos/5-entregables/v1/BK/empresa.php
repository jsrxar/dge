 ...
 */
    ...
    class public_ods_empresaPage extends Page
    {
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('public_ods_empresassearch', $this->dataset,
                array('id_empresa', 'no_empresa'),
                array($this->RenderText('Id Empresa'), $this->RenderText('Nombre Empresa')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('public_ods_empresaasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            $this->AdvancedSearchControl->setTimerInterval(1000);
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('id_empresa', $this->RenderText('Id Empresa')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('no_empresa', $this->RenderText('Nombre Empresa')));
        }
        ...
        protected function AddFieldColumns(Grid $grid)
        {
            ...
            $column->SetDescription($this->RenderText('Identificador único de Empresa.'));
            ...
            $column->SetFullTextWindowHandlerName('public_ods_empresaGrid_no_empresa_handler_list');
            $column->SetDescription($this->RenderText('Nombre de la Empresa.'));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
        }
        ...
        protected function AddSingleRecordViewColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('public_ods_empresaGrid_no_empresa_handler_view');
            $grid->AddSingleRecordViewColumn($column);
        }
        ...
        {
            //
            // Edit column for no_empresa field
            //
            $editor = new TextEdit('no_empresa_edit');
            $editor->SetSize(100);
            $editor->SetMaxLength(100);
            $editColumn = new CustomEditColumn('Nombre Empresa', 'no_empresa', $editor, $this->dataset);
        ...
        public function GetModalGridDeleteHandler() { return 'public_ods_empresa_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'public_ods_empresaGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
            ...
            $column = new TextViewColumn('no_empresa', 'Nombre Empresa', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'public_ods_empresaGrid_no_empresa_handler_list', $column);
