    ...
    class public_ods_lecturaPage extends Page
    {
        ...
        protected function CreateGridSearchControl(Grid $grid)
        {
            ...
            $grid->SearchControl = new SimpleSearch('public_ods_lecturassearch', $this->dataset,
                ...
                array($this->RenderText('Id Lectura'), $this->RenderText('Id Persona'), $this->RenderText('Id Lugar'), $this->RenderText('Id Origen Lectura'), $this->RenderText('Fe Fecha Lectura'), $this->RenderText('Nombre Usuario'), $this->RenderText('Descripción Usuario'), $this->RenderText('Código Lector'), $this->RenderText('Observaciones'), $this->RenderText('Id Carga')),
                array(
        ...
        protected function CreateGridAdvancedSearchControl(Grid $grid)
        {
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('ds_usuario', $this->RenderText('Descripción Usuario')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('co_lector', $this->RenderText('Código Lector')));
