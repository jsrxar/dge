 ...
 */
    ...
    class public_ods_metodologiaPage extends Page
    {
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('public_ods_metodologiassearch', $this->dataset,
                array('id_metodologia', 'no_metodologia', 'ds_metodologia', 'id_origen_no_origen'),
                array($this->RenderText('Id Metodologia'), $this->RenderText('Nombre'), $this->RenderText('Descripción Metodo'), $this->RenderText('Id Origen')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('public_ods_metodologiaasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
        ...
        protected function AddFieldColumns(Grid $grid)
        {
            ...
            $column->SetFullTextWindowHandlerName('public_ods_metodologiaGrid_no_metodologia_handler_list');
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('public_ods_metodologiaGrid_ds_metodologia_handler_list');
        ...
        protected function AddSingleRecordViewColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('public_ods_metodologiaGrid_no_metodologia_handler_view');
            $grid->AddSingleRecordViewColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('public_ods_metodologiaGrid_ds_metodologia_handler_view');
            $grid->AddSingleRecordViewColumn($column);
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            $editor = new TextAreaEdit('ds_metodologia_edit', 50, 8);
        ...
        public function GetModalGridDeleteHandler() { return 'public_ods_metodologia_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'public_ods_metodologiaGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
            ...
            $column = new TextViewColumn('no_metodologia', 'Nombre', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'public_ods_metodologiaGrid_no_metodologia_handler_list', $column);
            ...
            $column = new TextViewColumn('ds_metodologia', 'Descripción Metodo', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'public_ods_metodologiaGrid_ds_metodologia_handler_list', $column);
            GetApplication()->RegisterHTTPHandler($handler);//
            // View column for no_metodologia field
            //
            $column = new TextViewColumn('no_metodologia', 'Nombre', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'public_ods_metodologiaGrid_no_metodologia_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            //
            // View column for ds_metodologia field
            //
            $column = new TextViewColumn('ds_metodologia', 'Descripción Metodo', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'public_ods_metodologiaGrid_ds_metodologia_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            return $result;
        }
    ...
    try
    {
        $Page = new public_ods_metodologiaPage("metodologia.php", "public_ods_metodologia", GetCurrentUserGrantForDataSource("public.ods_metodologia"), 'UTF-8');
        $Page->SetShortCaption('Metodologia de Acción');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Metodologia');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("public.ods_metodologia"));
