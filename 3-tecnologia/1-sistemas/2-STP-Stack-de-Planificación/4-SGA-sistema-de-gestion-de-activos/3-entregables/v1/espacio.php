 ...
 */
    ...
    class public_ods_espacioPage extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            $this->dataset->AddLookupField('id_espacio_contenedor', 'public.ods_espacio', new IntegerField('id_espacio', null, null, true), new StringField('co_espacio', 'id_espacio_contenedor_co_espacio', 'id_espacio_contenedor_co_espacio_public_ods_espacio'), 'id_espacio_contenedor_co_espacio_public_ods_espacio');
        }
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('public_ods_espaciossearch', $this->dataset,
                array('id_espacio', 'id_tipo_espacio_ds_referencia', 'id_espacio_contenedor_co_espacio', 'co_espacio', 'no_espacio', 'nu_planta', 'co_plano'),
                array($this->RenderText('Id Espacio'), $this->RenderText('Id Tipo Espacio'), $this->RenderText('Id Espacio Contenedor'), $this->RenderText('Código Espacio'), $this->RenderText('Nombre Espacio'), $this->RenderText('Número Planta'), $this->RenderText('Código Plano')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('public_ods_espacioasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateLookupSearchInput('id_espacio_contenedor', $this->RenderText('Id Espacio Contenedor'), $lookupDataset, 'id_espacio', 'co_espacio', false, 8));
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('nu_planta', $this->RenderText('Número Planta')));
        ...
        protected function AddFieldColumns(Grid $grid)
        {
            ...
            //
            $column = new TextViewColumn('id_espacio_contenedor_co_espacio', 'Id Espacio Contenedor', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText('Identificador único del espacio contenedor (padre).'));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            $column->SetFullTextWindowHandlerName('public_ods_espacioGrid_no_espacio_handler_list');
            $column->SetDescription($this->RenderText('Nombre del espacio.'));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            
            //
            // View column for nu_planta field
            //
            $column = new TextViewColumn('nu_planta', 'Número Planta', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText('Número de planta.'));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
        ...
        protected function AddSingleRecordViewColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('public_ods_espacioGrid_no_espacio_handler_view');
            $grid->AddSingleRecordViewColumn($column);
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $editColumn = new LookUpEditColumn(
                ...
                $editor, 
                $this->dataset, 'id_espacio', 'co_espacio', $lookupDataset);
        ...
        public function GetModalGridDeleteHandler() { return 'public_ods_espacio_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'public_ods_espacioGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
            ...
            $column = new TextViewColumn('no_espacio', 'Nombre Espacio', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'public_ods_espacioGrid_no_espacio_handler_list', $column);
            GetApplication()->RegisterHTTPHandler($handler);//
            // View column for no_espacio field
            //
            $column = new TextViewColumn('no_espacio', 'Nombre Espacio', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'public_ods_espacioGrid_no_espacio_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            return $result;
        }
    ...
    try
    {
        $Page = new public_ods_espacioPage("espacio.php", "public_ods_espacio", GetCurrentUserGrantForDataSource("public.ods_espacio"), 'UTF-8');
        $Page->SetShortCaption('Espacio');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Espacio');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("public.ods_espacio"));
