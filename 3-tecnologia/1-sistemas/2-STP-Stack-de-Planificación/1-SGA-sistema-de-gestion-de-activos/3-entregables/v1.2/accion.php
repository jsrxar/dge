    ...
    class public_sga_accionPage extends Page
    {
        ...
        protected function CreateGridSearchControl(Grid $grid)
        {
            ...
            $grid->SearchControl = new SimpleSearch('public_sga_accionssearch', $this->dataset,
                array('id_accion', 'id_tipo_accion_ds_referencia', 'id_tipo_espacio_ds_referencia', 'id_sector_no_sector', 'id_tipo_bien_ds_referencia', 'id_origen_no_origen', 'id_metodologia_no_metodologia', 'id_periodicidad_no_periodicidad', 'fl_a_demanda', 'ds_referencia'),
                array($this->RenderText('Id Accion'), $this->RenderText('Tipo Accion'), $this->RenderText('Tipo Espacio'), $this->RenderText('Sector'), $this->RenderText('Tipo Bien'), $this->RenderText('Origen'), $this->RenderText('Metodología'), $this->RenderText('Periodicidad'), $this->RenderText('A Demanda'), $this->RenderText('Descripción')),
                array(
