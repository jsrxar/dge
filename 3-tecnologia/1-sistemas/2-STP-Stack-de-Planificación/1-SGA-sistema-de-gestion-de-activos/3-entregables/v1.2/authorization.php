...
$users = array('relevamiento' => 'ccee5504c9d889922b101124e9e43b71',
    'servicios-generales' => 'ccee5504c9d889922b101124e9e43b71',
    'admin' => 'ccee5504c9d889922b101124e9e43b71');

$usersIds = array('relevamiento' => -1, 'servicios-generales' => -1, 'admin' => -1);
...
$grants = array('guest' => 
    ...
    'defaultUser' => 
        ...
        'public.sga_sector' => new DataSourceSecurityInfo(false, false, false, false),
    ...
    'relevamiento' => 
        ...
        'public.sga_bien' => new DataSourceSecurityInfo(false, false, false, false),
        'public.sga_metodologia' => new DataSourceSecurityInfo(false, false, false, false),
        'public.sga_tipo_accion' => new DataSourceSecurityInfo(true, true, true, true),
        'public.sga_tipo_bien' => new DataSourceSecurityInfo(true, true, true, true),
        'public.sga_periodicidad' => new DataSourceSecurityInfo(false, false, false, false),
        'public.sga_planta' => new DataSourceSecurityInfo(false, false, false, false),
        'public.sga_sector' => new DataSourceSecurityInfo(false, false, false, false),
        'public.sga_origen' => new DataSourceSecurityInfo(false, false, false, false),
        'public.sga_tipo_espacio' => new DataSourceSecurityInfo(true, true, true, true))
    ,
    'servicios-generales' => 
        array('public.sga_accion' => new DataSourceSecurityInfo(true, true, true, true),
        'public.sga_tarea_plan' => new DataSourceSecurityInfo(true, true, true, true),
        'public.sga_espacio' => new DataSourceSecurityInfo(true, true, true, true),
        'public.sga_bien' => new DataSourceSecurityInfo(true, true, true, true),
        'public.sga_metodologia' => new DataSourceSecurityInfo(true, true, true, true),
        'public.sga_tipo_accion' => new DataSourceSecurityInfo(true, true, true, true),
        'public.sga_tipo_bien' => new DataSourceSecurityInfo(false, false, false, false),
        'public.sga_periodicidad' => new DataSourceSecurityInfo(true, true, true, true),
        'public.sga_planta' => new DataSourceSecurityInfo(false, false, false, false),
        'public.sga_sector' => new DataSourceSecurityInfo(false, false, false, false),
        'public.sga_origen' => new DataSourceSecurityInfo(false, false, false, false),
        'public.sga_tipo_espacio' => new DataSourceSecurityInfo(false, false, false, false))
...
$appGrants = array('guest' => new DataSourceSecurityInfo(false, false, false, false),
    ...
    'relevamiento' => new DataSourceSecurityInfo(false, false, false, false),
    'servicios-generales' => new DataSourceSecurityInfo(false, false, false, false),
