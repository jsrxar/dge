 ...
 */
    ...
    class public_ods_tipo_bienPage extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            $this->dataset->AddField($field, false);
            $this->dataset->AddLookupField('id_tipo_bien_padre', 'public.ods_tipo_bien', new IntegerField('id_tipo_bien', null, null, true), new StringField('ds_referencia', 'id_tipo_bien_padre_ds_referencia', 'id_tipo_bien_padre_ds_referencia_public_ods_tipo_bien'), 'id_tipo_bien_padre_ds_referencia_public_ods_tipo_bien');
        }
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('public_ods_tipo_bienssearch', $this->dataset,
                array('id_tipo_bien', 'no_tipo_bien', 'id_tipo_bien_padre_ds_referencia', 'ds_referencia'),
                array($this->RenderText('Id Tipo Bien'), $this->RenderText('Nombre Tipo Bien'), $this->RenderText('Id Tipo Bien Padre'), $this->RenderText('Descripción  Referencia')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('public_ods_tipo_bienasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateLookupSearchInput('id_tipo_bien_padre', $this->RenderText('Id Tipo Bien Padre'), $lookupDataset, 'id_tipo_bien', 'ds_referencia', false, 8));
        ...
        protected function AddFieldColumns(Grid $grid)
        {
            ...
            $column->SetFullTextWindowHandlerName('public_ods_tipo_bienGrid_no_tipo_bien_handler_list');
            ...
            //
            $column = new TextViewColumn('id_tipo_bien_padre_ds_referencia', 'Id Tipo Bien Padre', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText('Identificador único del tipo de bien padre (supertipo).'));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('public_ods_tipo_bienGrid_ds_referencia_handler_list');
        ...
        protected function AddSingleRecordViewColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('public_ods_tipo_bienGrid_no_tipo_bien_handler_view');
            $grid->AddSingleRecordViewColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('public_ods_tipo_bienGrid_ds_referencia_handler_view');
            $grid->AddSingleRecordViewColumn($column);
        }
        ...
        protected function AddInsertColumns(Grid $grid)
        {
            ...
            $editColumn = new CustomEditColumn('Descripción  Referencia', 'ds_referencia', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
            if ($this->GetSecurityInfo()->HasAddGrant())
        ...
        public function GetModalGridDeleteHandler() { return 'public_ods_tipo_bien_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'public_ods_tipo_bienGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
            ...
            $column = new TextViewColumn('no_tipo_bien', 'Nombre Tipo Bien', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'public_ods_tipo_bienGrid_no_tipo_bien_handler_list', $column);
            ...
            $column = new TextViewColumn('ds_referencia', 'Descripción  Referencia', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'public_ods_tipo_bienGrid_ds_referencia_handler_list', $column);
            GetApplication()->RegisterHTTPHandler($handler);//
            // View column for no_tipo_bien field
            //
            $column = new TextViewColumn('no_tipo_bien', 'Nombre Tipo Bien', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'public_ods_tipo_bienGrid_no_tipo_bien_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            //
            // View column for ds_referencia field
            //
            $column = new TextViewColumn('ds_referencia', 'Descripción  Referencia', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'public_ods_tipo_bienGrid_ds_referencia_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            return $result;
        }
    ...
    try
    {
        $Page = new public_ods_tipo_bienPage("tipo_bien.php", "public_ods_tipo_bien", GetCurrentUserGrantForDataSource("public.ods_tipo_bien"), 'UTF-8');
        $Page->SetShortCaption('Tipo Bien');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Tipo Bien');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("public.ods_tipo_bien"));
