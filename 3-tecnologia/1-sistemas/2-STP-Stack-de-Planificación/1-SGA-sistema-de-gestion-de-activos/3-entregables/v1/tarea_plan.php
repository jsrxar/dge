    ...
    class public_ods_tarea_planPage extends Page
    {
        ...
        protected function CreateGridSearchControl(Grid $grid)
        {
            ...
            $grid->SearchControl = new SimpleSearch('public_ods_tarea_planssearch', $this->dataset,
                ...
                array($this->RenderText('Id Tarea Plan'), $this->RenderText('Acción'), $this->RenderText('Espacio'), $this->RenderText('Bien'), $this->RenderText('Periodicidad'), $this->RenderText('Detalle')),
                array(
