...
CREATE TABLE public.factura (
                ...
                id_proyecto INTEGER,
                nu_factura VARCHAR(20),
                fe_factura DATE,
                nu_cuota INTEGER,
                va_factura DOUBLE PRECISION NOT NULL,
                fl_estado_factura BOOLEAN,
...
COMMENT ON COLUMN public.factura.fl_estado_factura IS 'Factura OK?';
...
COMMENT ON COLUMN public.item.id_convenio IS 'Identificador único del convenio.';
...
CREATE TABLE public.documento (
                ...
                no_documento VARCHAR(100) DEFAULT 'Sin Archivo',
...
COMMENT ON COLUMN public.documento.fl_estado IS 'Estado OK?';
...
ALTER TABLE public.item ADD CONSTRAINT convenio_item_fk
FOREIGN KEY (id_convenio)
REFERENCES public.convenio (id_convenio)
ON DELETE NO ACTION
ON UPDATE NO ACTION
